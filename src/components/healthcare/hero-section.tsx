...
export function HealthcareHero() {
    return (
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-hc-surface overflow-hidden">
            ...
            <div className="container-wide relative z-10">
                <div className="max-w-4xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded border border-hc-teal/20 bg-hc-teal/5 text-hc-teal text-xs font-bold tracking-widest uppercase mb-6">
                    ...
                    <p className="text-lg md:text-2xl text-hc-olive max-w-2xl leading-relaxed mb-10 font-manrope">
                        Compliant. Efficient. NABH-Ready hospital and clinic planning — from concept to execution.
                    </p>

                    {/* Key Value Points */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 border-t border-hc-grey pt-8 max-w-3xl">
                        <div className="flex flex-col gap-2">
                            <h4 className="font-bold text-hc-teal flex items-center gap-2">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Button
                            size="lg"
                            className="bg-hc-teal hover:bg-hc-teal/90 text-white rounded-none px-8 h-14 text-base"
                            asChild
                        >
                            <Link href="/contact">
                        ...
                        <Button
                            variant="outline"
                            size="lg"
                            className="border-hc-teal text-hc-teal hover:bg-hc-teal/5 rounded-none px-8 h-14 text-base"
                            asChild
                        >
                            <Link href="/contact">
