        ...
        <section className="py-24 bg-ivory text-center">
            <div className="container-wide max-w-3xl">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <Button size="lg" className="bg-navy text-white hover:bg-navy/90 h-14 px-8 text-base" asChild>
                        <Link href="/contact">Book Free Design Consultation</Link>
                    </Button>
                    <Button variant="outline" size="lg" className="border-navy text-navy hover:bg-navy/5 h-14 px-8 text-base" asChild>
