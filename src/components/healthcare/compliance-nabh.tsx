        ...
        <section className="py-24 bg-hc-teal text-white">
            <div className="container-wide text-center max-w-4xl mx-auto">
                <div className="inline-flex items-center justify-center p-3 bg-white/10 rounded-full mb-8">
                    <Shield className="text-hc-yellow w-8 h-8" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                    <div className="p-6 border border-white/20 bg-white/10 rounded-lg">
                        <h4 className="text-hc-yellow font-bold text-lg mb-3">Fire Safety (NBC)</h4>
                    ...
                    <div className="p-6 border border-white/20 bg-white/10 rounded-lg">
                        <h4 className="text-hc-yellow font-bold text-lg mb-3">Infection Control</h4>
                        <p className="text-sm text-white/80">Seamless surfaces, coving details, and isolation room negative pressure planning.</p>
                    </div>
                    <div className="p-6 border border-white/20 bg-white/10 rounded-lg">
                        <h4 className="text-hc-yellow font-bold text-lg mb-3">Patient Safety</h4>
