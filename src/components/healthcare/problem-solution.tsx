...
export function ProblemsSolved() {
    return (
        <section className="py-12 md:py-24 bg-hc-grey/10">
            <div className="container-wide">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    <div>
                        <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase text-hc-olive/80 block mb-2">The Challenge</span>
                        <h2 className="text-2xl md:text-4xl font-serif text-ink mb-4 md:mb-6">Why traditional interior design fails in healthcare.</h2>
                        <p className="text-ink/70 text-base md:text-lg leading-relaxed mb-6 md:mb-8">
                        ...
                        <div className="space-y-4 md:space-y-6">
                            <div className="bg-white p-5 md:p-6 rounded border border-red-100 shadow-sm">
                                <h4 className="flex items-center gap-2 text-red-800 font-bold mb-2 text-xs md:text-sm uppercase tracking-wide">
                            ...
                            <div className="bg-hc-teal p-5 md:p-6 rounded shadow-md text-white">
                                <h4 className="flex items-center gap-2 text-hc-yellow font-bold mb-2 text-xs md:text-sm uppercase tracking-wide">
                    ...
                    <div className="grid gap-4 md:gap-6">
                        <div className="bg-white p-6 md:p-8 border-l-4 border-hc-teal shadow-sm">
                            <h3 className="font-bold text-base md:text-lg text-ink mb-2">OT & ICU Zoning</h3>
                        ...
                        <div className="bg-white p-6 md:p-8 border-l-4 border-hc-teal shadow-sm">
                            <h3 className="font-bold text-base md:text-lg text-ink mb-2">Outpatient Flow</h3>
                        ...
                        <div className="bg-white p-6 md:p-8 border-l-4 border-hc-teal shadow-sm">
                            <h3 className="font-bold text-base md:text-lg text-ink mb-2">Material Selection</h3>
